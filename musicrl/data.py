...
class RandomMidiDataGenerator:
    ...
    def compute_batch_of_generated(self, batch_size):
        ...
        fake_midis = [self.mapper.vec2midi(seq) for seq in fake_seqs]
        fake_preprocessed = [self.preprocess(midi) for midi in fake_midis]
    ...
    def compute_batch(self):
        ...
        min_length = min(min_length, self.max_num_timeframes)
        x = np.array(
            [mel[:min_length] for mel in real_preprocessed + fake_preprocessed]
        )
        y = np.array(
