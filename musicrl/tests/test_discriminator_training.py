...
class DiscriminatorTrainingTest(unittest.TestCase):
    def test_with_seq_lstm(self):
        ...
        train_generator = RandomMidiDataGenerator(real_midis[::2], seq_lstm.make_preprocessor(mapper), mapper, 4, 100)
        test_generator = RandomMidiDataGenerator(real_midis[1::2], seq_lstm.make_preprocessor(mapper), mapper, 4, 100)
    ...
    def test_with_mel_lstm(self):
        ...
        train_generator = RandomMidiDataGenerator(real_midis[::2], mel_lstm.preprocess, mapper, 4, 100)
        test_generator = RandomMidiDataGenerator(real_midis[1::2], mel_lstm.preprocess, mapper, 4, 100)
