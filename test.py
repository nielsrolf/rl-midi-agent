...
train_generator = RandomMidiDataGenerator(real_midis[::2], mel_lstm.preprocess, mapper, 4)
test_generator = RandomMidiDataGenerator(real_midis[1::2], mel_lstm.preprocess, mapper, 4)
